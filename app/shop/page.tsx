...
export const metadata: Metadata = { title: "فروشگاه قطعات الکترونیکی", description: "خرید ماژول، برد کنترل، منبع تغذیه و ابزار الکترونیک با ثبت سفارش و پشتیبانی فنی Voltina." };

export default function ShopPage() {
  return <ModalProvider>
    <header className="shop-page-header"><div className="wrap shop-page-nav"><Link href="/" className="shop-page-brand"><img src="/images/voltina-mark.png" alt="Voltina Electronics" /></Link><div><Link href="/">صفحهٔ اصلی</Link><a href="#products">محصولات</a><a href="#order-form" className="shop-page-cta">ثبت سفارش</a></div></div></header>
